...
export default function HeadColumn({className}) {
  return (
    <div className={className}>
      ...
      <div className="flex items-center justify-center gap-x-2 select-none">
        ...
        <div className="font-semibold text-base">Todo</div>
        <div className="rounded-[50%] bg-gray-200 w-[18px] h-[18px] relative">
            <div className="absolute left-[5px] text-gray-600 font-medium text-sm">1</div>
        </div>
      </div>
      <TooltipProvider delayDuration={0}>
        <Tooltip>
          ...
          <TooltipContent side="bottom" className="text-gray-300">
            <p>Actions for column: Todo</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      </div>
      <div className="px-4 pt-2 text-gray-500 text-sm font-light">This item hasn't been started</div>
    </div>
  )
}
